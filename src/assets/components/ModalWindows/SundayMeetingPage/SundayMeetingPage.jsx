...
export const SundayMeetingPage = () => {
	const [showModalSundayMeetingPage, setShowModalSundayMeetingPage] =
		useState(false);
		...
		<div className='events-page-block'>
			<div className='event__item'>
				...
				<div className='event__text'>
					<h2 className='event__title'>Воскресные собрания</h2>
					<button
						className='btn'
					...
					<div className='event-page__container'>
						<div className='block-title-and-description'>
							...
							<p className='event-page__description'>
								Воскресная литургия это особое мероприятие,
								когда все члены нашей дружной общины встречаются
								для того, чтобы услышать Слово, вместе
								помолиться и поклониться Небесному Богу. После
								собрания вас ждет уютное общение за чашкой кофе.
							</p>
						</div>
